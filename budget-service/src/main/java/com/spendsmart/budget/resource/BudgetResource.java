...
public class BudgetResource {
    ...
    public ResponseEntity<BudgetProgress> getProgress(@PathVariable int id) {
    ...
    public ResponseEntity<List<String>> getAlerts(@PathVariable int userId) {
        return ResponseEntity.ok(budgetService.checkBudgetAlerts(userId));
    }

    // POST /budgets/{id}/reset — Reset budget period
    @PostMapping("/{id}/reset")
    public ResponseEntity<Void> resetPeriod(@PathVariable int id) {
